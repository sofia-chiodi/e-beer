...
productsRouter.post('/cart/add', productsController.addToCart);
productsRouter.post('/cart/update', productsController.updateCartItem);
productsRouter.post('/cart/remove', productsController.removeCartItem);
productsRouter.post('/cart/checkout', productsController.checkoutCart);
